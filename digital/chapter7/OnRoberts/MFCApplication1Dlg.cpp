...
{
	int i, j;
	double RobertsMask_R[3][3] = { {-1., 0., 0.}, {0., 1.,
	0.}, {0., 0., 0.} };
	double RobertsMask_C[3][3] = { {0.,0.,-1.},{0.,1.,0.},{0.,0.,0.} };
	for (i = 0; i < m_Re_size; i++) {
		m_OutputImage[i] = p_src_image[i];
	}
	OnMaskProcess(p_src_image, RobertsMask_R);
	OnMaskProcess(m_OutputImage, RobertsMask_C);
	for (i = 0; i < m_Re_size; i++) {
