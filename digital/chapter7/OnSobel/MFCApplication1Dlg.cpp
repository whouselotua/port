...
{
	int i, j;
	double SobelMask_R[3][3] = { {-1., -2., -1.}, {0., 0., 0.}, {1., 2., 1.} };
	double SobelMask_C[3][3] = { {1.,0.,-1.},{2.,0.,-2.},{1.,0.,-1.} };
	for (i = 0; i < m_Re_size; i++) {
		m_OutputImage[i] = p_src_image[i];
	}
	OnMaskProcess(p_src_image, SobelMask_R);
	OnMaskProcess(m_OutputImage, SobelMask_C);
	for (i = 0; i < m_Re_size; i++) {
